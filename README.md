...
## Установка (composer)
```bash
composer require k-shym/urfa-client "1.*"
```
...
| protocol | ssl | **none** или **ssl** или **tls** (доступно с версии UTM-5.3-002-update16) или **auto** (доступно с версии UTM-5.3-005-update2, работает с OpenSSL 1.1) |
...
## История изменений
**v1.3.6**
- Исправлена ошибка при повторном вызове одной функции, проявлялась с версии 1.3.5 
...
- Отключение `ssl` для старых версий ядра `'protocol' => 'none'` #26
